YUI.add('gallery-ac-plugin-v2', function(Y) {
 ...
 **/
function ACPlugin2 () { ACPlugin2.superclass.constructor.apply(this, arguments) };
...
Y.Plugin.ACPlugin2 = Y.extend(
    ...
    { // prototype
        ...
        next : function (e) { 
        	e.preventDefault(); this.fire("ac:next") 
        },
        previous : function (e) { 
        	e.preventDefault(); this.fire("ac:previous") 
        },
        close : function () { 
        	this.fire("ac:hide") 
        }
...
}, '@VERSION@' ,{requires:['node-base','node-pluginhost','plugin','gallery-value-change','event-key']});
